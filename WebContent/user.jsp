...
<h1>Welcome to Home Page</h1><hr>
	...
	<tr>
	<td align="center"><form action="addreservation"><input type="submit" value="Book vehicle"/></form></td>
	</tr>
	<tr>
	<td align="center"><form action="getreservation"><input type="submit" value="View Booking Details"/></form></td>
	</tr>
	<tr>
